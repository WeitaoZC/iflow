...
if __name__ == '__main__':
    ...
    optimizer = optim.Adamax(params,lr = lr,weight_decay= 0)
    ...
    for i in range(nr_epochs):
        ...
        if i%1 == 0:
            with torch.no_grad():
                ...
                # writer.add_scalar('8_ReLu_Adamax_0.000577', dtw_e, i)
                # writer.add_scalars('error', {'Frechet_error': frechet_e, 'DTW_error':dtw_e},i)
                if dtw_e < error:
                    error = dtw_e
                    # torch.save(iflow.state_dict(), os.getcwd() + "/results/lasa_3d/normal/saved_model/" + filename + "_8_ReLu_Adamax_0.000577_" +"best.pt")
