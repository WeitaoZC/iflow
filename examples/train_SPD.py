...
writer = SummaryWriter("comp_training_SPD")
...
if __name__ == '__main__':
        ...
        for i in range(nr_epochs):
            ...
            if i%5 == 0 or i>20:
                with torch.no_grad():
                    ...
                    if dtw_e < error:
                        error = dtw_e
                        torch.save(iflow.state_dict(), os.getcwd() + "/best_models/fake_SPD/" + filename + str(args.depth) +"best.pt")
    ...
    np.save(os.getcwd() +"/best_models/fake_SPD/"+ str(args.depth) +"_all_dtw_e.npy", all_DTW)
    writer.close()
